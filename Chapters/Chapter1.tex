...
time synchronization protocols\cite{kendall2007practical}. Data plane switches are used to record network telemetry data in a relational database, which is then
...
determine the root cause of faults in the network and address them\cite{kendall2007practical}.
